...
# --- Products Endpoints: Refactored to Avoid Parameter Overlap/Conflict ---
from fastapi import APIRouter, HTTPException, status, Depends, Request
from typing import List
from app.models.product import ProductCreate, ProductUpdate, ProductInDB
from app.services.product_service import ProductService
...
# --- Dynamic endpoints after static ---
...
@router.put("/{product_id}", response_model=ProductInDB, tags=["products"])
